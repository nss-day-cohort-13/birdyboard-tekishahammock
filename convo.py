...
class Conversation:
  ...
  def __init__(self, allowed_users=None, public_status=True, ):
    ...
    - allowed_users - a tuple containing two user_ids for users allowed to access a private convo, defaults to none, passed in from new_chirp: private on menus.py
    - public_status - whether or not a conversation is public, passed in from new chirp functions from menus.py
    """
